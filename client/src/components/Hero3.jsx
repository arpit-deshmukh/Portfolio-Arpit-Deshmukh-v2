...
export default function Hero2() {
  ...
  className="relative w-full flex justify-center md:justify-start md:-ml-10"
>
  <div className="relative p-1 bg-gradient-to-r from-blue-500/40 via-purple-500/40 to-blue-600/40 
                  backdrop-blur-md border border-white/10 shadow-lg rounded-full">
    
    <div className="bg-white/5 rounded-full overflow-hidden border border-white/10 w-[280px] h-[280px]">
      <img
        src="/AD/arpitv1.png"
        alt="Arpit"
